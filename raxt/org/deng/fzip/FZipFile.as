...
package org.deng.fzip
{
	...
	public class FZipFile
	{
		 ...
		 * @private
		 */		
		private static var HAS_INFLATE:Boolean = (describeType(ByteArray)..method.(@name == "inflate").length() == 1);
